...
| golang.org/x/mod/semver                 | https://cs.opensource.google/go/x/mod/+/v0.39.0:LICENSE         | BSD-3-Clause |
| golang.org/x/sync/errgroup              | https://cs.opensource.google/go/x/sync/+/v0.22.0:LICENSE        | BSD-3-Clause |
| golang.org/x/tools                      | https://cs.opensource.google/go/x/tools/+/v0.49.0:LICENSE       | BSD-3-Clause |
